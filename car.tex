...
\begin{document}
    ...
    \begin{frame}{Architecture matérielle}
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \node[box, fill=myblue] (C2) at (0,0) {GNSS};
        ...
        \note{
            ...
            Ne se sert que d'un GPS et de la caméra \\
            \vspace{0.5cm}
            \textbf{Traitement} \\
    ...
    \begin{frame}{Résultats \& Conclusion}
        ...
        \note{
            \textbf{Time code} : 1:15 $\rightarrow$ 1:15 \\
            \vspace{0.5cm}
        }
    \end{frame}
    ...
    %     \changefontsizes{9pt}
    %     \begin{itemize}
    %         \item \textbf{Kart Repository}, \textit{www.github.com/gwendalp/kart}
    %         \item \textbf{Cours Middleware}, Thomas Le Mezo, Simon Rohou
    %         \item \textbf{Cours Traitement Images}, Hélène Thomas
    %         \item \textbf{Kalmooc}, Luc Jaulin, \textit{www.ensta-bretagne.fr/jaulin/kalmooc.html}
    %         \item \textbf{Robmooc}, Luc Jaulin, \textit{www.ensta-bretagne.fr/jaulin/robmooc.html}
    %     \end{itemize}
    % \end{frame}
